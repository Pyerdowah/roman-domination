...
W związku z tym suma wag WCRDF jest najmniejsza możliwa przy spełnieniu warunków definicji, co kończy dowód.
...
\textbf{Warunek dominacji rzymskiej} zapewnia ograniczenie (1):
...
\textbf{3. Minimalizacja funkcji celu.}
